...
zengfu2013_215=[];
for i=1:7
    zengfu2015_2017(i)= data(5 ,i )- data(7,i);
end
% disp(zengfu2015_2017);         % 输出增幅
sumvalue=0;                                  % 增幅的总和
for i=1:7
    sumvalue=sumvalue+abs(zengfu2015_2017(i)  );
end
disp(sumvalue);
zengfubilv  =  zengfu2015_2017  /  sumvalue;
